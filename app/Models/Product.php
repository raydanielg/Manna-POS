...
class Product extends Model {
    protected $fillable = ['created_by','name','sku','barcode','brand_id','category_id','unit_id','tax_rate_id','description','image','purchase_price','selling_price','stock_quantity','reorder_level','status'];
