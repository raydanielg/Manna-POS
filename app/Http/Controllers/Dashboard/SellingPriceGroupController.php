...
class SellingPriceGroupController extends Controller {
    public function index(Request $req) {
        $q = SellingPriceGroup::forCurrentUser($this->currentBusinessId());
    ...
    public function show(SellingPriceGroup $sellingPriceGroup) { $this->ensureOwns($sellingPriceGroup); return response()->json($sellingPriceGroup); }
    public function update(Request $req, SellingPriceGroup $sellingPriceGroup) {
        $this->ensureOwns($sellingPriceGroup);
    ...
    public function destroy(SellingPriceGroup $sellingPriceGroup) { $this->ensureOwns($sellingPriceGroup); $sellingPriceGroup->delete(); return response()->json(['success'=>true]); }
}
