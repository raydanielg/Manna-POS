...
class ProductVariationController extends Controller {
    ...
    public function show(ProductVariation $productVariation) { return response()->json($productVariation->load('product')); }
    ...
    public function destroy(ProductVariation $productVariation) { $productVariation->delete(); return response()->json(['success'=>true]); }
}
