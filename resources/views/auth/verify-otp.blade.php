...
@section('form-header')
    ...
    <p class="auth-form-subtitle">Enter the 6-digit code sent to <strong>{{ $user->email }}</strong></p>
@endsection
...
<div class="activation-card">
    ...
    <p>We sent a code to your email. Can't find it? Check your spam folder or <a href="{{ url('/activate/' . $user->activation_token) }}">click here to activate instantly</a>.</p>
</div>
