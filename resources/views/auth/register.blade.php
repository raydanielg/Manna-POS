        ...
        <div class="max-w-md my-auto">
            ...
            <ul class="space-y-4" id="progress-list">
                ...
                <li class="flex items-center" id="track-personal">
                    <div class="flex-shrink-0 w-6 h-6 flex items-center justify-center mr-3 text-emerald-500 icon-check">
                    ...
                    <div class="flex-shrink-0 w-6 h-6 flex items-center justify-center mr-3 text-emerald-500 icon-spinner hidden">
                ...
                <li class="flex items-center" id="track-password">
                    <div class="flex-shrink-0 w-6 h-6 flex items-center justify-center mr-3 text-emerald-500 icon-check hidden">
                        <svg class="w-5 h-5 stroke-[2.5]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
                    </div>
