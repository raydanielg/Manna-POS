            ...
            <div class="bg-white rounded-lg border border-slate-200/80 shadow-lg p-8 sm:p-10">
                ...
                <div class="mt-6">
                    <div style="display:flex;align-items:center;gap:0.75rem;margin-bottom:0.75rem;">
                        ...
                        <span style="font-size:0.7rem;color:#94a3b8;font-weight:500;">Or sign up with</span>
                        <div style="flex:1;height:1px;background:#e2e8f0;"></div>
                    </div>
                ...
                {{-- Account login link --}}
                <div class="mt-6 pt-6 border-t border-slate-100 text-center text-xs font-bold text-slate-500">
