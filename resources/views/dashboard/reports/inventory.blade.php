...
<head>
    ...
    <title>Inventory Reports — {{ config('app.name', 'MannaPOS') }}</title>
...
<aside class="sidebar">
    ...
    <nav class="flex-1 py-2">
        ...
        <a href="{{ route('dashboard.reports.sales') }}" class="nav-item">
            <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
            Sales Reports
        </a>
        <a href="{{ route('dashboard.reports.inventory') }}" class="nav-item active">
...
<div class="main-wrap">
    ...
    <div class="content">
        ...
        <div class="report-card">
            ...
            <div class="text-center text-gray-400 py-8">No inventory data available yet.</div>
        </div>
    </div>
</div>
