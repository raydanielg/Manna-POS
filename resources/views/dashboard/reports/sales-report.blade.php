...
<head>
    ...
    <title>Sales Report — {{ config('app.name', 'MannaPOS') }}</title>
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-reports">
            ...
            <div class="dropdown-children">
                <a href="#" class="child-item active">Sales Report</a>
...
<div class="main-wrap">
    ...
    <div class="content">
        <div class="card">
            ...
            <p class="text-gray-600">Sales report will be displayed here.</p>
        </div>
    </div>
</div>
