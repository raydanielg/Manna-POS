...
<head>
    ...
    <title>Purchase Report — {{ config('app.name', 'MannaPOS') }}</title>
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-reports">
            ...
            <div class="dropdown-children">
                ...
                <a href="#" class="child-item active">Purchase Report</a>
...
<div class="main-wrap">
    ...
    <div class="content">
        <div class="card">
            <div class="section-title">Purchase Report</div>
            <p class="text-gray-600">Purchase report will be displayed here.</p>
        </div>
    </div>
</div>
