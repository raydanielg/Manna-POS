...
<head>
    ...
    <title>Add Purchase — {{ config('app.name', 'MannaPOS') }}</title>
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-purchases">
            ...
            <div class="dropdown-children">
                ...
                <a href="#" class="child-item active">Add Purchase</a>
    ...
    <div class="content">
        <div class="card">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" placeholder="Select supplier">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-input" placeholder="Enter total amount">
            </div>
            <button class="btn-save">Save Purchase</button>
        </div>
    </div>
</div>
