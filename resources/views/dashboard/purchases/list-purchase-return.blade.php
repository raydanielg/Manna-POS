...
<head>
    ...
    <title>List Purchase Return — {{ config('app.name', 'MannaPOS') }}</title>
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-purchases">
            ...
            <div class="dropdown-children">
                ...
                <a href="#" class="child-item active">List Purchase Return</a>
            </div>
        </div>
    </div>
...
<div class="main-wrap">
    <header class="top-header">
        <h1 class="page-title">List Purchase Return</h1>
        <div class="user-chip">
    ...
    <div class="content">
        <div class="table-card">
            <div class="flex justify-between items-center mb-4">
                <div class="section-title mb-0">All Purchase Returns</div>
            ...
            <table class="tbl">
                ...
                <tbody>
                    <tr><td colspan="5" class="text-center text-gray-400 py-8">No purchase returns yet.</td></tr>
                </tbody>
            </table>
        </div>
    </div>
