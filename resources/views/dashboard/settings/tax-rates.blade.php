...
<head>
    ...
    <title>Tax Rates — {{ config('app.name', 'MannaPOS') }}</title>
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-settings">
            ...
            <div class="dropdown-children">
                ...
                <a href="#" class="child-item active">Tax Rates</a>
            </div>
        </div>
    </div>
    ...
    <div class="content">
        <div class="table-card">
            <div class="flex justify-between items-center mb-4">
                <div class="section-title mb-0">All Tax Rates</div>
                <button class="btn-add">+ Add Tax Rate</button>
            </div>
            <table class="tbl">
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr><td colspan="3" class="text-center text-gray-400 py-8">No tax rates yet.</td></tr>
                </tbody>
            </table>
        </div>
    </div>
