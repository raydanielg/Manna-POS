...
<head>
    ...
    <title>Barcode Settings — {{ config('app.name', 'MannaPOS') }}</title>
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-settings">
            ...
            <div class="dropdown-children">
                ...
                <a href="#" class="child-item active">Barcode Settings</a>
...
<div class="main-wrap">
    <header class="top-header">
        <h1 class="page-title">Barcode Settings</h1>
        <div class="user-chip">
    ...
    <div class="content">
        <div class="card">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-input" placeholder="Enter barcode height">
            </div>
