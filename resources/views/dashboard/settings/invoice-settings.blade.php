...
<head>
    ...
    <title>Invoice Settings — {{ config('app.name', 'MannaPOS') }}</title>
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-settings">
            ...
            <div class="dropdown-children">
                ...
                <a href="#" class="child-item">Business Location</a>
                <a href="#" class="child-item active">Invoice Settings</a>
    ...
    <div class="content">
        <div class="card">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" placeholder="Enter invoice prefix">
            </div>
            <div class="form-group">
                <label class="form-label">Invoice Starting Number</label>
                <input type="number" class="form-input" placeholder="Enter starting number">
            </div>
            <div class="form-group">
                <label class="form-label">Invoice Terms</label>
                <textarea class="form-input" rows="3" placeholder="Enter invoice terms and conditions"></textarea>
            </div>
