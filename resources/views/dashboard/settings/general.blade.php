...
<head>
    ...
    <title>General Settings — {{ config('app.name', 'MannaPOS') }}</title>
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-settings">
            ...
            <div class="dropdown-children">
                <a href="#" class="child-item active">General</a>
    ...
    <div class="content">
        <div class="card">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" value="{{ config('app.name', 'MannaPOS') }}">
            </div>
            <div class="form-group">
                <label class="form-label">Currency</label>
                <input type="text" class="form-input" placeholder="Enter currency symbol">
            </div>
            <div class="form-group">
