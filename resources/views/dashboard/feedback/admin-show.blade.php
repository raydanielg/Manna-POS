...
<div class="dash-content animate__animated animate__fadeInUp">
    ...
    <div class="flex flex-wrap items-center justify-between gap-3 mb-5">
        ...
        <div class="flex items-center gap-2">
            <form action="{{ route('dashboard.feedback.admin.priority', $feedback) }}" method="POST" class="inline">
                @csrf @method('PATCH')
                <select name="priority" onchange="this.form.submit()" class="rounded-lg border border-slate-200 px-2.5 py-1.5 text-xs font-semibold focus:border-blue-500 outline-none">
            ...
            <form action="{{ route('dashboard.feedback.admin.status', $feedback) }}" method="POST" class="inline">
                @csrf @method('PATCH')
                <select name="status" onchange="this.form.submit()" class="rounded-lg border border-slate-200 px-2.5 py-1.5 text-xs font-semibold focus:border-blue-500 outline-none">
    ...
    <div class="dash-section">
        ...
        <div class="dash-section-content">
            ...
            <form action="{{ route('dashboard.feedback.admin.reply', $feedback) }}" method="POST" class="mt-5 pt-4 border-t border-slate-100">
                @csrf
                <div class="flex gap-3">
                    <div class="flex-1">
