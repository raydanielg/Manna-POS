...
<head>
    ...
    <title>Transactions — {{ config('app.name', 'MannaPOS') }}</title>
...
<aside class="sidebar">
    ...
    <nav class="flex-1 py-2">
        ...
        <a href="{{ route('dashboard.sales.transactions') }}" class="nav-item active">
    ...
    <div class="content">
        <div class="table-card">
            ...
            <table class="tbl">
                ...
                <tbody>
                    <tr><td colspan="5" class="text-center text-gray-400 py-8">No transactions yet.</td></tr>
                </tbody>
            </table>
        </div>
    </div>
