...
<head>
    ...
    <title>Loyalty Program — {{ config('app.name', 'MannaPOS') }}</title>
...
<aside class="sidebar">
    ...
    <nav class="flex-1 py-2">
        ...
        <a href="{{ route('dashboard.customers.all') }}" class="nav-item">
        ...
        <a href="{{ route('dashboard.customers.loyalty') }}" class="nav-item active">
...
<div class="main-wrap">
    ...
    <div class="content">
        <div class="table-card">
            <div class="section-title">Loyalty Members</div>
            <table class="tbl">
                <thead>
                    <tr>
                        <th>Customer</th>
                ...
                <tbody>
                    <tr><td colspan="5" class="text-center text-gray-400 py-8">No loyalty members yet.</td></tr>
                </tbody>
            </table>
        </div>
    </div>
