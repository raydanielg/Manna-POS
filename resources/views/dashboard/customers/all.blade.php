...
<head>
    ...
    <title>All Customers — {{ config('app.name', 'MannaPOS') }}</title>
...
<aside class="sidebar">
    ...
    <nav class="flex-1 py-2">
        ...
        <a href="{{ route('dashboard.customers.all') }}" class="nav-item active">
        ...
        <a href="{{ route('dashboard.customers.loyalty') }}" class="nav-item">
    ...
    <div class="content">
        <div class="table-card">
            <div class="flex justify-between items-center mb-4">
                <div class="section-title mb-0">Customer List</div>
