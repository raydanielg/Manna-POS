...
<head>
    ...
    <title>Import Contacts — {{ config('app.name', 'MannaPOS') }}</title>
    ...
    <style>
        ...
        .btn-upload { padding: 0.5rem 1rem; background: #10B981; color: white; border: none; border-radius: 8px; font-size: 0.85rem; font-weight: 600; cursor: pointer; }
...
<aside class="sidebar">
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-contacts">
            ...
            <div class="dropdown-children">
                ...
                <a href="#" class="child-item active">Import Contacts</a>
            </div>
        </div>
    </div>
...
<div class="main-wrap">
    ...
    <div class="content">
        <div class="card">
            <div class="section-title">Import Contacts from CSV</div>
            <p class="text-gray-600 mb-4">Upload a CSV file to import contacts in bulk.</p>
            <div class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center mb-4">
                <svg class="w-12 h-12 text-gray-400 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/></svg>
                <p class="text-gray-500">Drag and drop your CSV file here, or click to browse</p>
            </div>
            <button class="btn-upload">Upload CSV File</button>
        </div>
    </div>
</div>
