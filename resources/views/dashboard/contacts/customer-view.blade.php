...
<div class="cv-wrap">
        ...
        <div class="cv-header-inner">
            ...
            <div class="cv-header-info">
                ...
                <div class="cv-header-meta">
                    <span class="cv-status {{ $customer->status === 'inactive' ? 'inactive' : '' }}">{{ $customer->status }}</span>
                    @if($customer->group)
                        <span>&middot;</span>
    ...
    <div class="cv-grid">
        <div class="cv-stat">
            <div class="cv-stat-icon" style="background: linear-gradient(135deg, #dbeafe, #ede9fe); color: #2563eb;">
        ...
        <div class="cv-stat">
            <div class="cv-stat-icon" style="background: linear-gradient(135deg, #d1fae5, #dcfce7); color: #059669;">
        ...
        <div class="cv-stat">
            <div class="cv-stat-icon" style="background: linear-gradient(135deg, #fef3c7, #fde68a); color: #d97706;">
