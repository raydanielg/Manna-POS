...
<head>
    ...
    <title>Import Sales — {{ config('app.name', 'MannaPOS') }}</title>
...
<aside class="sidebar">
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-sell">
            ...
            <div class="dropdown-children">
                ...
                <a href="#" class="child-item active">Import Sales</a>
            </div>
        </div>
    </div>
...
<div class="main-wrap">
    ...
    <div class="content">
        <div class="card">
            <div class="section-title">Import Sales from CSV</div>
            <p class="text-gray-600 mb-4">Upload a CSV file to import sales in bulk.</p>
