...
<head>
    ...
    <title>List POS — {{ config('app.name', 'MannaPOS') }}</title>
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-sell">
            ...
            <div class="dropdown-children">
                ...
                <a href="#" class="child-item active">List POS</a>
...
<div class="main-wrap">
    <header class="top-header">
        <h1 class="page-title">List POS</h1>
        <div class="user-chip">
    ...
    <div class="content">
        <div class="table-card">
            <div class="flex justify-between items-center mb-4">
                <div class="section-title mb-0">All POS Transactions</div>
                <button class="btn-add">+ Add POS</button>
            </div>
            <table class="tbl">
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr><td colspan="5" class="text-center text-gray-400 py-8">No POS transactions yet.</td></tr>
                </tbody>
            </table>
        </div>
    </div>
