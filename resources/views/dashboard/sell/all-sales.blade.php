...
<head>
    ...
    <title>All Sales — {{ config('app.name', 'MannaPOS') }}</title>
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-sell">
            ...
            <div class="dropdown-children">
                <a href="#" class="child-item active">All Sales</a>
    ...
    <div class="content">
        <div class="table-card">
            <div class="flex justify-between items-center mb-4">
                <div class="section-title mb-0">All Sales</div>
            ...
            <table class="tbl">
                ...
                <tbody>
                    <tr><td colspan="5" class="text-center text-gray-400 py-8">No sales yet.</td></tr>
                </tbody>
            </table>
        </div>
    </div>
