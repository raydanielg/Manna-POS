...
<head>
    ...
    <title>Add Draft — {{ config('app.name', 'MannaPOS') }}</title>
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-sell">
            ...
            <div class="dropdown-children">
                ...
                <a href="#" class="child-item active">Add Draft</a>
...
<div class="main-wrap">
    <header class="top-header">
        <h1 class="page-title">Add Draft</h1>
        <div class="user-chip">
    ...
    <div class="content">
        <div class="card">
            <div class="section-title">Draft Sale</div>
            <p class="text-gray-600">Create a draft sale here.</p>
        </div>
    </div>
</div>
