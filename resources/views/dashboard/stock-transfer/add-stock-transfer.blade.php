...
<head>
    ...
    <title>Add Stock Transfer — {{ config('app.name', 'MannaPOS') }}</title>
...
<aside class="sidebar">
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-stock-transfer">
            <div class="dropdown-toggle" onclick="toggleDropdown('dropdown-stock-transfer')">
                <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M7 16l-4-4m0 0l4-4m-4 4h18"/></svg>
                Stock Transfer
            ...
            <div class="dropdown-children">
                <a href="#" class="child-item">List Stock Transfer</a>
                <a href="#" class="child-item active">Add Stock Transfer</a>
            </div>
        </div>
    </div>
...
<div class="main-wrap">
    ...
    <div class="content">
        <div class="card">
            <div class="section-title">Stock Transfer Information</div>
            <div class="form-group">
                <label class="form-label">From Location</label>
                <input type="text" class="form-input" placeholder="Select source location">
            </div>
            <div class="form-group">
                <label class="form-label">To Location</label>
                <input type="text" class="form-input" placeholder="Select destination location">
            </div>
            <div class="form-group">
                <label class="form-label">Transfer Date</label>
                <input type="date" class="form-input">
            </div>
            <button class="btn-save">Save Transfer</button>
        </div>
    </div>
</div>
