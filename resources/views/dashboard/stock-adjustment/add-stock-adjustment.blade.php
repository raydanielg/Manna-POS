...
<head>
    ...
    <title>Add Stock Adjustment — {{ config('app.name', 'MannaPOS') }}</title>
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-stock-adjustment">
            ...
            <div class="dropdown-children">
                <a href="#" class="child-item">List Stock Adjustment</a>
                <a href="#" class="child-item active">Add Stock Adjustment</a>
            </div>
        </div>
    </div>
...
<div class="main-wrap">
    ...
    <div class="content">
        <div class="card">
            <div class="section-title">Stock Adjustment Information</div>
            <div class="form-group">
                <label class="form-label">Product</label>
                <input type="text" class="form-input" placeholder="Select product">
            </div>
            <div class="form-group">
            ...
            <button class="btn-save">Save Adjustment</button>
        </div>
    </div>
</div>
