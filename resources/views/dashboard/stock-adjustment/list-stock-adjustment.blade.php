...
<head>
    ...
    <title>List Stock Adjustment — {{ config('app.name', 'MannaPOS') }}</title>
...
<aside class="sidebar">
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-stock-adjustment">
            <div class="dropdown-toggle" onclick="toggleDropdown('dropdown-stock-adjustment')">
                <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m-3-3h6"/></svg>
                Stock Adjustment
            ...
            <div class="dropdown-children">
                <a href="#" class="child-item active">List Stock Adjustment</a>
...
<div class="main-wrap">
    <header class="top-header">
        <h1 class="page-title">List Stock Adjustment</h1>
        <div class="user-chip">
    ...
    <div class="content">
        <div class="table-card">
            <div class="flex justify-between items-center mb-4">
                <div class="section-title mb-0">All Stock Adjustments</div>
                <button class="btn-add">+ Add Adjustment</button>
            </div>
            <table class="tbl">
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr><td colspan="5" class="text-center text-gray-400 py-8">No stock adjustments yet.</td></tr>
                </tbody>
            </table>
        </div>
    </div>
