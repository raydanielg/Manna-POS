...
<head>
    ...
    <title>Add Expense — {{ config('app.name', 'MannaPOS') }}</title>
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-expenses">
            ...
            <div class="dropdown-children">
                ...
                <a href="#" class="child-item active">Add Expense</a>
    ...
    <div class="content">
        <div class="card">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" placeholder="Select expense category">
            </div>
            <div class="form-group">
