...
<div class="page-card" style="max-width:700px;">
  ...
  <div style="padding:3rem;text-align:center;">
    ...
    <h3 style="font-size:1.1rem;font-weight:700;color:#1e293b;margin-bottom:0.5rem;">Add Expense</h3>
    <p style="color:#64748b;font-size:0.9rem;margin-bottom:1.5rem;">Use the Expenses list page to add expenses via the modal form.</p>
