...
<head>
    ...
    <title>List Expenses — {{ config('app.name', 'MannaPOS') }}</title>
...
<aside class="sidebar">
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-expenses">
            <div class="dropdown-toggle" onclick="toggleDropdown('dropdown-expenses')">
                <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 0 0 2 -2v-14a2 2 0 0 0 -2 -2h-10a2 2 0 0 0 -2 2v14a2 2 0 0 0 2 2z"/></svg>
                Expenses
            ...
            <div class="dropdown-children">
                <a href="#" class="child-item active">List Expenses</a>
...
<div class="main-wrap">
    <header class="top-header">
        <h1 class="page-title">List Expenses</h1>
        <div class="user-chip">
    ...
    <div class="content">
        <div class="table-card">
            <div class="flex justify-between items-center mb-4">
                <div class="section-title mb-0">All Expenses</div>
            ...
            <table class="tbl">
                ...
                <tbody>
                    <tr><td colspan="5" class="text-center text-gray-400 py-8">No expenses yet.</td></tr>
                </tbody>
            </table>
        </div>
    </div>
