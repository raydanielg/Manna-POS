...
<head>
    ...
    <title>Expense Categories — {{ config('app.name', 'MannaPOS') }}</title>
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-expenses">
            ...
            <div class="dropdown-children">
                ...
                <a href="#" class="child-item active">Expense Categories</a>
            </div>
        </div>
    </div>
    ...
    <div class="content">
        <div class="table-card">
            <div class="flex justify-between items-center mb-4">
                <div class="section-title mb-0">All Expense Categories</div>
            ...
            <table class="tbl">
                ...
                <tbody>
                    <tr><td colspan="3" class="text-center text-gray-400 py-8">No expense categories yet.</td></tr>
                </tbody>
            </table>
        </div>
    </div>
