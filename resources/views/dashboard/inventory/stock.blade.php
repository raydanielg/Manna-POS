...
<head>
    ...
    <title>Stock Alerts — {{ config('app.name', 'MannaPOS') }}</title>
    ...
    <style>
        ...
        .badge-alert { font-size: 0.68rem; font-weight: 600; padding: 0.2rem 0.6rem; border-radius: 9999px; background: #fee2e2; color: #dc2626; }
    </style>
</head>
...
<aside class="sidebar">
    ...
    <nav class="flex-1 py-2">
        ...
        <a href="{{ route('dashboard.inventory.categories') }}" class="nav-item">
        ...
        <a href="{{ route('dashboard.inventory.stock') }}" class="nav-item active">
    ...
    <div class="content">
        <div class="table-card">
            ...
            <table class="tbl">
                ...
                <tbody>
                    <tr><td colspan="5" class="text-center text-gray-400 py-8">No stock alerts.</td></tr>
                </tbody>
            </table>
        </div>
    </div>
