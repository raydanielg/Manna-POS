...
<head>
    ...
    <title>Categories — {{ config('app.name', 'MannaPOS') }}</title>
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-products">
            ...
            <div class="dropdown-children">
                ...
                <a href="#" class="child-item active">Categories</a>
    ...
    <div class="content">
        <div class="table-card">
            <div class="flex justify-between items-center mb-4">
                <div class="section-title mb-0">All Categories</div>
            ...
            <table class="tbl">
                ...
                <tbody>
                    <tr><td colspan="4" class="text-center text-gray-400 py-8">No categories yet.</td></tr>
                </tbody>
            </table>
        </div>
    </div>
