...
<head>
    ...
    <title>Variations — {{ config('app.name', 'MannaPOS') }}</title>
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-products">
            ...
            <div class="dropdown-children">
                ...
                <a href="#" class="child-item active">Variations</a>
    ...
    <div class="content">
        <div class="table-card">
            <div class="flex justify-between items-center mb-4">
                <div class="section-title mb-0">Product Variations</div>
                <button class="btn-add">+ Add Variation</button>
            </div>
            <table class="tbl">
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr><td colspan="4" class="text-center text-gray-400 py-8">No variations yet.</td></tr>
                </tbody>
            </table>
        </div>
    </div>
