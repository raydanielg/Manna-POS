...
<head>
    ...
    <title>Update Price — {{ config('app.name', 'MannaPOS') }}</title>
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-products">
            ...
            <div class="dropdown-children">
                ...
                <a href="#" class="child-item active">Update Price</a>
...
<div class="main-wrap">
    ...
    <div class="content">
        <div class="card">
            <div class="section-title">Update Product Prices</div>
            <table class="tbl">
                <thead>
                    <tr>
                        <th>Product</th>
                ...
                <tbody>
                    <tr><td colspan="3" class="text-center text-gray-400 py-8">No products to update.</td></tr>
                </tbody>
            </table>
            <button class="btn-save mt-4">Update Prices</button>
        </div>
    </div>
</div>
