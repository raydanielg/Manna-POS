...
<head>
    ...
    <title>Import Opening Stock — {{ config('app.name', 'MannaPOS') }}</title>
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-products">
            ...
            <div class="dropdown-children">
                ...
                <a href="#" class="child-item active">Import Opening Stock</a>
...
<div class="main-wrap">
    ...
    <div class="content">
        <div class="card">
            <div class="section-title">Import Opening Stock from CSV</div>
            <p class="text-gray-600 mb-4">Upload a CSV file to import opening stock in bulk.</p>
