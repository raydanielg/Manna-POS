...
<head>
    ...
    <title>Add Product — {{ config('app.name', 'MannaPOS') }}</title>
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-products">
            ...
            <div class="dropdown-children">
                ...
                <a href="#" class="child-item active">Add Product</a>
    ...
    <div class="content">
        <div class="card">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" placeholder="Select category">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-input" placeholder="Enter stock quantity">
            </div>
