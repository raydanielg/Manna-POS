...
<head>
    ...
    <title>Selling Price Group — {{ config('app.name', 'MannaPOS') }}</title>
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-products">
            ...
            <div class="dropdown-children">
                ...
                <a href="#" class="child-item active">Selling Price Group</a>
...
<div class="main-wrap">
    <header class="top-header">
        <h1 class="page-title">Selling Price Group</h1>
        <div class="user-chip">
    ...
    <div class="content">
        <div class="table-card">
            <div class="flex justify-between items-center mb-4">
                <div class="section-title mb-0">Selling Price Groups</div>
                <button class="btn-add">+ Add Price Group</button>
            </div>
            <table class="tbl">
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr><td colspan="4" class="text-center text-gray-400 py-8">No price groups yet.</td></tr>
                </tbody>
            </table>
        </div>
    </div>
