...
<head>
    ...
    <title>Print Labels — {{ config('app.name', 'MannaPOS') }}</title>
    ...
    <style>
        ...
        .btn-print { padding: 0.6rem 1.5rem; background: #10B981; color: white; border: none; border-radius: 8px; font-size: 0.85rem; font-weight: 600; cursor: pointer; }
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-products">
            ...
            <div class="dropdown-children">
                ...
                <a href="#" class="child-item active">Print Labels</a>
...
<div class="main-wrap">
    ...
    <div class="content">
        <div class="card">
            <div class="section-title">Print Product Labels</div>
            <p class="text-gray-600 mb-4">Select products to print labels for.</p>
            <button class="btn-print">Print Labels</button>
        </div>
    </div>
</div>
