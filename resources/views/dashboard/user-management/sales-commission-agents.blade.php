...
<head>
    ...
    <title>Sales Commission Agents — {{ config('app.name', 'MannaPOS') }}</title>
...
<aside class="sidebar">
    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown open" id="dropdown-user">
            ...
            <div class="dropdown-children">
                ...
                <a href="#" class="child-item active">Sales Commission Agents</a>
            </div>
        </div>
    </div>
    ...
    <div class="content">
        <div class="table-card">
            <div class="flex justify-between items-center mb-4">
                <div class="section-title mb-0">All Sales Commission Agents</div>
            ...
            <table class="tbl">
                ...
                <tbody>
                    <tr><td colspan="4" class="text-center text-gray-400 py-8">No agents yet.</td></tr>
                </tbody>
            </table>
        </div>
    </div>
