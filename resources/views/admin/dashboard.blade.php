    ...
    <div class="sidebar-content">
        ...
        <div class="dropdown" id="dropdown-user">
            ...
            <div class="dropdown-children">
                ...
                <a href="{{ route('admin.users') }}" class="child-item">Add New User</a>
                ...
                <a href="#" class="child-item">User Activity Log</a>
                <a href="#" class="child-item">Login History</a>
                <a href="#" class="child-item">Blocked Users</a>
            </div>
        </div>

        {{-- Staff Management --}}
        <div class="dropdown" id="dropdown-staff">
            ...
            <div class="dropdown-children">
                <a href="#" class="child-item">All Staff</a>
                <a href="#" class="child-item">Add Staff Member</a>
                <a href="#" class="child-item">Staff Roles</a>
                <a href="#" class="child-item">Staff Attendance</a>
                <a href="#" class="child-item">Staff Schedule</a>
                <a href="#" class="child-item">Staff Performance</a>
            </div>
        </div>
        ...
        {{-- Business Management --}}
        <div class="dropdown" id="dropdown-business">
            ...
            <div class="dropdown-children">
                <a href="#" class="child-item">All Businesses</a>
                <a href="#" class="child-item">Business Verification</a>
                ...
                <a href="#" class="child-item">Business Categories</a>
                <a href="#" class="child-item">Pending Approvals</a>
            </div>
        </div>
        ...
        <div class="dropdown" id="dropdown-plans">
            ...
            <div class="dropdown-children">
                ...
                <a href="{{ route('admin.plans') }}" class="child-item">Create New Plan</a>
                <a href="{{ route('admin.subscriptions') }}" class="child-item">All Subscriptions</a>
                <a href="#" class="child-item">Active Subscriptions</a>
                <a href="#" class="child-item">Expired Subscriptions</a>
                <a href="#" class="child-item">Trial Subscriptions</a>
            </div>
        </div>

        {{-- Billing & Payments --}}
        <div class="dropdown" id="dropdown-billing">
            ...
            <div class="dropdown-children">
                <a href="#" class="child-item">All Invoices</a>
                <a href="#" class="child-item">Payment History</a>
                <a href="#" class="child-item">Pending Payments</a>
                <a href="#" class="child-item">Payment Gateways</a>
                <a href="#" class="child-item">Transaction Logs</a>
                <a href="#" class="child-item">Refunds</a>
            </div>
        </div>
        ...
        <div class="dropdown" id="dropdown-finance">
            ...
            <div class="dropdown-children">
                <a href="#" class="child-item">Revenue Overview</a>
                <a href="{{ route('admin.reports') }}" class="child-item">Sales Reports</a>
                <a href="{{ route('admin.reports') }}" class="child-item">Profit & Loss</a>
                <a href="#" class="child-item">Tax Reports</a>
                <a href="#" class="child-item">Commission Reports</a>
                <a href="#" class="child-item">Payouts</a>
            </div>
        </div>
        ...
        <div class="dropdown" id="dropdown-notifications">
            <div class="dropdown-toggle" onclick="toggleDropdown('dropdown-notifications')">
            ...
            <div class="dropdown-children">
                ...
                <a href="#" class="child-item">Email Templates</a>
                <a href="#" class="child-item">SMS Templates</a>
                <a href="#" class="child-item">Push Notifications</a>
                <a href="#" class="child-item">Send Broadcast</a>
                <a href="#" class="child-item">Announcements</a>
            </div>
        </div>
        ...
        <div class="dropdown" id="dropdown-settings">
            ...
            <div class="dropdown-children">
                ...
                <a href="#" class="child-item">Currency Settings</a>
                <a href="#" class="child-item">Receipt Printers</a>
            </div>
        </div>

        {{-- System Configuration --}}
        <div class="dropdown" id="dropdown-system">
            ...
            <div class="dropdown-children">
                <a href="#" class="child-item">General Configuration</a>
                <a href="#" class="child-item">Email Configuration</a>
                <a href="#" class="child-item">SMS Configuration</a>
                <a href="#" class="child-item">Payment Gateways</a>
                <a href="#" class="child-item">API Keys & Integrations</a>
                <a href="#" class="child-item">Security Settings</a>
                <a href="#" class="child-item">Maintenance Mode</a>
            </div>
        </div>
        ...
        <div class="dropdown" id="dropdown-reports">
            ...
            <div class="dropdown-children">
                ...
                <a href="{{ route('admin.reports') }}" class="child-item">Profit & Loss</a>
                <a href="#" class="child-item">User Activity Report</a>
                <a href="#" class="child-item">System Audit Trail</a>
                <a href="#" class="child-item">Error Logs</a>
            </div>
        </div>
        ...
        <div class="dropdown" id="dropdown-tools">
            ...
            <div class="dropdown-children">
                <a href="#" class="child-item">Database Backup</a>
                <a href="#" class="child-item">File Backup</a>
                <a href="#" class="child-item">Restore Backup</a>
                <a href="#" class="child-item">Scheduled Backups</a>
                <a href="#" class="child-item">System Logs</a>
                <a href="#" class="child-item">Cache Management</a>
            </div>
        </div>
